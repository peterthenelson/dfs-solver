use variant_sudoku::{
    cages::{CageBuilder, CageChecker, CAGE_FEATURE}, constraint::MultiConstraint, core::FeatureVec, kropki::{KropkiBuilder, KropkiChecker, KROPKI_BLACK_FEATURE}, ranker::{OverlaySensitiveLinearRanker, NUM_POSSIBLE_FEATURE}, solver::PuzzleSetter, sudoku::{nine_standard_overlay, NineStd, StandardSudokuChecker}, tui::{solve_interactive, NineStdTui}
};
...
fn main() {
    solve_interactive::<ThreeColorTheorem, NineStdTui>().unwrap();
}