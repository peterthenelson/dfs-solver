use std::fmt::Debug;
use crate::{constraint::Constraint, core::{empty_set, CertainDecision, ConstraintResult, DecisionGrid, Key, Index, State, Stateful, UVSet, Value, WithId}, sudoku::{NineStdVal, StdOverlay, StdState}};
...
pub struct MagicSquareChecker {
    ...
    evens: UVSet<u8>,
    odds: UVSet<u8>,
    ms_feature: Key<WithId>,
    ms_mid_attr: Key<WithId>,
    ms_mid_5_attr: Key<WithId>,
    ms_corner_attr: Key<WithId>,
    ms_side_attr: Key<WithId>,
    ms_sum_attr: Key<WithId>,
    ms_sum_exact_attr: Key<WithId>,
    ms_sum_if_attr: Key<WithId>,
}
