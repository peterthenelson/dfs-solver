...
use crate::core::{singleton_set, Key, BranchPoint, ConstraintResult, DecisionGrid, Error, Index, Overlay, State, Value, WithId};
...
mod test {
    ...
    use crate::core::{Key, Stateful, Value};
