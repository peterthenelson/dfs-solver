...
use crate::core::{full_set, singleton_set, unpack_singleton, ConstraintResult, DecisionGrid, Error, Key, Index, Overlay, State, Stateful, UVSet, Value, WithId};
...
pub struct DutchWhisperChecker {
    ...
    dw_feature: Key<WithId>,
    dw_too_close_attr: Key<WithId>,
    illegal: Option<(Index, NineStdVal, Key<WithId>)>,
}
